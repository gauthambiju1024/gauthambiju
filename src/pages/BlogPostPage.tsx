...
export default function BlogPostPage() {
  ...
  if (loading) {
    return (
      <PageTransition>
        <div className="min-h-screen flex items-center justify-center" style={{ background: 'hsl(var(--card))' }}>
  ...
  if (!post) {
    return (
      <PageTransition>
        <div className="min-h-screen flex flex-col items-center justify-center gap-4" style={{ background: 'hsl(var(--card))' }}>
  ...
  return (
    <PageTransition>
      <div className="min-h-screen" style={{ background: 'hsl(var(--card))' }}>
