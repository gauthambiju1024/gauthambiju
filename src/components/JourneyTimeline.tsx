...
const JourneyTimeline = () => {
  ...
  return (
    <section className="py-6 md:py-8 h-full flex flex-col relative overflow-hidden">
      ...
      <div className="px-6 md:px-12 flex items-center gap-3 mb-3 relative z-10">
        <div className="h-px flex-1 bg-border" />
        <span className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground font-mono">Journey</span>
      </div>

      <div className="px-6 md:px-12 mb-4 relative z-10">
      ...
      {/* Timeline */}
      <div className="px-6 md:px-12 relative z-10 flex-1 min-h-0 overflow-hidden">
        <div className="relative max-w-2xl mx-auto h-full">
          ...
          {milestones.map((m, i) => (
            <motion.div
              key={m.id}
              className="relative pl-12 md:pl-16 pb-4 last:pb-0"
